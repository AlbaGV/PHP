<?php
  ...
  ?>
    <form action="pagina.php" method="get">
      <input type="hidden" name="ejercicio" value="Ex10GV01">
  ...
  if ($n < 0) {
    ...
    for ($i = $cuentaNoPrimos; $i < $cuentaNoPrimos + $cuentaPrimos; $i++) {
      $numero[$i] = $Primos[$i - $cuentaNoPrimos];
    }

    // Muestra el array resultante

    // Índice
    echo "<br>Array resultante con los no primos al principio y los primos al final:<br>";
    echo "<table><tr>";
    for ($i = 0; $i < ($contadorNumeros -1); $i++) {
      echo "<td>$i</td>";
    }
