...
<?php // Tienda ///////////////////////////////////////////////////////
  ...
  foreach ($producto as $codigo => $elemento) {
    ...
    <form action="pagina.php" method="post">
      <input type="hidden" name="ejercicio" value="tienda_detalle">
...
?>
  ...
  foreach ($producto as $cod => $elemento) {
    if ($_SESSION[carrito][$cod] > 0) {
      ...
      <form action="pagina.php" method="post">
        <input type="hidden" name="ejercicio" value="tienda_comfirmacion_borrar">
  ...
  <b>Total: <?=$total?> €</b>
  <form action="pagina.php" method="post">
      <input type="hidden" name="ejercicio" value="tienda_compra">
      <input type="hidden" name="codigo" value="<?=$codigo?>">
      <input type="hidden" name="accion" value="finalizar">
      <input type="submit" value="Finalizar compra">
    </form>
  <form action="pagina.php" method="post">
      <input type="hidden" name="ejercicio" value="tienda_comfirmacion_vaciar">
      <input type="hidden" name="codigo" value="<?=$codigo?>">
